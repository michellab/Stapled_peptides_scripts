...
if __name__ == "__main__":
    ...
    if steps.get(args.start_from)<4 and REMD==1:
    ...
    if steps.get(args.start_from)<4 and REMD==0:
        equilibration(300)
